...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('product_id', 'product_name', 'category', 'shop', 'price', 'quantity', 'created', 'product_image')
...
class ReviewAdmin(admin.ModelAdmin):
    list_display = ('review_id', 'order', 'product', 'rating', 'review_date', 'review_text', 'review_image')
