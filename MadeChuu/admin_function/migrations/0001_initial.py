# Generated by Django 5.1.5 on 2025-02-06 04:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_date', models.DateTimeField(blank=True, null=True)),
                ('status_order', models.TextField(blank=True)),
            ],
            options={
                'db_table': 'order',
                'managed': False,
        ...
        migrations.CreateModel(
            name='OrderProducts',
            fields=[
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admin_function.order')),
                ('quantity', models.IntegerField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('promotion', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='admin_function.promotion')),
            ],
            options={
