    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(blank=True, choices=[('wait', 'รอการตรวจสอบ'), ('confirmed', 'ยืนยันแล้ว'), ('rejected', 'ถูกปฏิเสธ')], max_length=50, null=True)),
                ('image_payment', models.ImageField(blank=True, null=True, upload_to='receipts/')),
            ],
            options={
                'db_table': 'payment',
                'managed': False,
        ...
        migrations.CreateModel(
            name='OrderProducts',
            fields=[
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='payment.order')),
                ('quantity', models.IntegerField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('promotion', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='payment.promotion')),
            ],
            options={
