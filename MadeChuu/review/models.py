...
class Admin(models.Model):
    ...
    def __str__(self):
        return f"{self.firstname_admin} {self.lastname_admin}"
...
class Claim(models.Model):
    ...
    def __str__(self):
        return f"Claim {self.claim_id} - Status: {self.status}"
...
class Delivery(models.Model):
    ...
    def __str__(self):
        return f"Delivery {self.delivery_id} - Status: {self.delivery_status}"
...
class FavoriteProducts(models.Model):
    ...
    def __str__(self):
        return f"Favorite Product {self.favorite_products_id} for User {self.user_id}"
...
class PromotionProducts(models.Model):
    ...
    def __str__(self):
        return f"Promotion {self.promotion_id} - Product {self.product_id}"
...
class RecommendedProduct(models.Model):
    ...
    def __str__(self):
        return f"Recommended Product {self.recommend_products_id} for User {self.user_id}"
...
class Review(models.Model):
    ...
    order = models.ForeignKey(Order, models.DO_NOTHING, blank=True, null=True)
    product = models.ForeignKey('Product', models.DO_NOTHING, blank=True, null=True)
    review_date = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    rating = models.IntegerField(blank=True, null=True)
    review_text = models.CharField(max_length=1000, blank=True, null=True)
    review_image = models.CharField(max_length=255, blank=True, null=True)  
...
class Transaction(models.Model):
    ...
    def __str__(self):
        return f"Transaction {self.transaction_id} - Type: {self.transaction_type_id}"
